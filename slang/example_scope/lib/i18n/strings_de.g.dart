...
class TranslationsDe implements Translations {
	...
	@override late final _TranslationsSubScreenDe subScreen = _TranslationsSubScreenDe._(_root);
...
// Path: subScreen
class _TranslationsSubScreenDe implements TranslationsSubScreenEn {
	_TranslationsSubScreenDe._(this._root);

	final TranslationsDe _root; // ignore: unused_field

	// Translations
	@override String get title => TranslationOverrides.string(_root.$meta, 'subScreen.title', {}) ?? 'Zweiter Bildschirm';
}
...
extension on TranslationsDe {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'subScreen.title': return TranslationOverrides.string(_root.$meta, 'subScreen.title', {}) ?? 'Zweiter Bildschirm';
