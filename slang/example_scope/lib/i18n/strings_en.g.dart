...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	late final TranslationsSubScreenEn subScreen = TranslationsSubScreenEn._(_root);
...
// Path: subScreen
class TranslationsSubScreenEn {
	TranslationsSubScreenEn._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get title => TranslationOverrides.string(_root.$meta, 'subScreen.title', {}) ?? 'Second screen';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'subScreen.title': return TranslationOverrides.string(_root.$meta, 'subScreen.title', {}) ?? 'Second screen';
